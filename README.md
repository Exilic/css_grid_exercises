...
A sample of the more interesting daily exercises done. The motivation for making them were one part learning css, one part visual experimentation. One rule was to never use class or id as selectors. All html-code is semantic.
